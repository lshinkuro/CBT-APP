...
export const useExamStore = create<ExamState>((set, get) => ({
  ...
  questions: [
    // TIU Questions
    {
      ...
      subSubType: 'TIU',
      explanation: 'Beda = (suku ketiga - suku pertama) / 2 = (9-3)/2 = 3. Suku kelima = suku pertama + 4(beda) = 3 + 4(3) = 15'
    },
    {
      id: '2',
      ...
      subSubType: 'TIU',
      explanation: 'Menggunakan metode eliminasi: \n2x + 3y = 12 | ×3 | 6x + 9y = 36\n3x - 2y = 4  | ×2 | 6x - 4y = 8\nKurangkan persamaan: 13y = 28\ny = 2.15\nSubstitusi ke persamaan pertama:\n2x + 3(2.15) = 12\n2x + 6.45 = 12\n2x = 5.55\nx = 3'
    },
    ...
    // TKP Questions
    {
      ...
      subSubType: 'TKP',
      explanation: 'Jawaban terbaik adalah menegur dan membantu memperbaiki kesalahan karena menunjukkan sikap kooperatif dan profesional dalam bekerja'
    }
  ],
  answers: {},
  scores: {
